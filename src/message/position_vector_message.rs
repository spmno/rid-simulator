...
impl Message for PositionVectorMessage {
    ...
    fn from_bytes(data: &[u8]) -> Result<Self, MessageError>  {
        ...
        let track_direction = byte0 & 0x01 ; // 1位: 航迹角方向标志
        let speed_multiplier = byte0 & 0x01 ; // 0位: 速度乘数
